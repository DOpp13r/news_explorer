      ...
      <div className="about__content">
        ...
        <div className="about__info">
          ...
          <p className="about__text">
            Hello, my name is Nathan Do. I am an aspiring software engineer in
            the making! Throughout this program, I further utilized my previous
          ...
          <p className="about__text">
            ...
            applications. The role at my job conducts quality control
            inspections, implementing quality management process, performing
            quality audits, and ensuring the compliance with quality standards.
          </p>
        </div>
      </div>
    </section>
